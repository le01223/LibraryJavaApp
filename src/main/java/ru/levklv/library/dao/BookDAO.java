...
public class BookDAO {
    ...
    public void update(int id, Book updatedBook) {
        jdbcTemplate.update("UPDATE Book SET title=?, authorname=?, yearofwriting=? WHERE id=?",
                updatedBook.getTitle(), updatedBook.getAuthorName(), updatedBook.getYearOfWriting(), id);
    }
    ...
    public Person getBookOwner(int id) {
        return jdbcTemplate.query("SELECT Person.* FROM Book INNER JOIN Person ON Book.person_id = Person.id " +
